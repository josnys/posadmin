          ...
          <React.Fragment key="security-index">
               ...
               <DataContainer>
                    <div className="col-span-12">
                         {can(auth.user, 'create-presentation') && (<InertiaLink href={route('presentation.create')} className="bg-gray-300 hover:bg-gray-400 mr-2 text-gray-800 text-sm py-1 px-1 rounded inline-flex items-center">
                                   ...
                                   return <tr key={id}>
                                        ...
                                        <td className="border px-4 py-2">
                                             <DropdownButton caption="Actions" color="blue">
                                                  {can(auth.user, 'update-presentation') && (<InertiaLink href={route('presentation.edit', id)} className="flex block px-6 py-2 text-gray-600 hover:bg-gray-100 hover:text-gray-700">
...
Index.layout = page => <Layout children={page} header={'Presentations'} />;
