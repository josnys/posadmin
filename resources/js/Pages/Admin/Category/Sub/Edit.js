...
const Edit = () => {
     ...
     function handleSubmit(e) {
          e.preventDefault();
          setSending(true);
          Inertia.post(route('subcategory.update', [data.category.id, data.sub.id]), values).then(() => {
               setSending(false);
          });
     }
                         ...
                         <div className="md:col-span-1">
                              <div className="px-4 sm:px-0">
                                   ...
                                   <p className="mt-1 text-sm text-gray-600">
                                        Update a subcategory for <span className="font-bold">{data.category.name}</span> category.
                                   </p>
                              </div>
                         </div>
                         <DataCard>
...
Edit.layout = page => <Layout children={page} header={'Edit Subcategory'} />;
