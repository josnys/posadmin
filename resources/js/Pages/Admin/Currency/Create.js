...
const Create = () => {
     ...
     function handleSubmit(e) {
          e.preventDefault();
          setSending(true);
          Inertia.post(route('currency.store'), values).then(() => {
               setSending(false);
          });
     }
                    ...
                    <ProfileCard>
                         <div className="md:col-span-1">
                              <div className="px-4 sm:px-0">
                                   <h3 className="text-lg font-medium text-gray-900">Create Currency</h3>
                                   <p className="mt-1 text-sm text-gray-600">
                                        Create different currency to be used in the system.
                                   </p>
                              </div>
                         </div>
                         <DataCard>
