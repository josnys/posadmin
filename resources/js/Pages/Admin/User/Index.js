                                   ...
                                   return <tr key={id}>
                                        ...
                                        <td className="border px-4 py-2">
                                             <DropdownButton caption="Actions" color="blue">
                                                  ...
                                                  {can(auth.user, 'assign-role') && (<InertiaLink href={route('user.get.store', id)} className="flex block px-6 py-2 text-gray-600 hover:bg-gray-100 hover:text-gray-700">
                                                       <Icon name={'office'} className={'fill-current w-5 h-5 mr-2'} />
                                                       Assign Store
                                                  </InertiaLink>)}
                                             </DropdownButton>
                                        </td>
