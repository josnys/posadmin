                         ...
                         <div className="px-4 py-5 sm:p-6">
                              <div className="grid grid-cols-6 gap-6">
                                   <div className="col-span-12">
                                        <InertiaLink href={route('product.edit', data.id)} className="bg-transparent border border-blue-500 text-sm text-blue-500 p-1 rounded focus:outline-none hover:bg-blue-600 hover:text-blue-100 inline-flex items-center">
