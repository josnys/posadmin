...
const Create = () => {
     ...
     function handleSubmit(e) {
          ...
          Inertia.post(route('product.store'), formData).then(() => {
               setSending(false);
          });
     }
                         ...
                         <div className="md:col-span-1">
                              <div className="px-4 sm:px-0">
                                   ...
                                   <p className="mt-1 text-sm text-gray-600">
                                        Create a new product in the system. Put in mind that after creating the product, you will still have to configure it to match all your needs
                                   </p>
                              </div>
                         </div>
                         <DataCard>
                              <div className="px-4 py-5 sm:p-6">
                                   <div className="grid grid-cols-6 gap-6">
                                        <div className="col-span-12 text-right">
                                             <InertiaLink href={route('product.index')} className="bg-transparent border border-gray-500 text-sm text-gray-500 p-1 rounded focus:outline-none hover:bg-gray-600 hover:text-gray-100 inline-flex items-center">
