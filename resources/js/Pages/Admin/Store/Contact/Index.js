          ...
          <React.Fragment key="security-index">
               ...
               <DataContainer>
                    ...
                    <table className="table-fixed col-span-12 text-sm">
                         ...
                         <tbody>
                              {data.contacts.data.map(({id, type, reference, link, status, statusCaption}) => {
                                   return <tr key={id}>
                                        <td className="border px-4 py-2">{type}</td>
                                        <td className="border px-4 py-2">{reference}</td>
                                        <td className="border px-4 py-2 text-center">{link}</td>
...
Index.layout = page => <Layout children={page} header={'Store Contacts'} />;
