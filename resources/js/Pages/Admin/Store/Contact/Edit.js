...
const Edit = () => {
     ...
     function handleSubmit(e) {
          e.preventDefault();
          setSending(true);
          Inertia.post(route('store.contact.update', [data.id, data.contact.id]), values).then(() => {
               setSending(false);
          });
     }
     ...
     return (
          <React.Fragment key="uprofile">
               <Helmet>
                    <title>Edit Store Contact</title>
               </Helmet>
               <form onSubmit={handleSubmit}>
                    <ProfileCard>
                         <div className="md:col-span-1">
                              <div className="px-4 sm:px-0">
                                   <h3 className="text-lg font-medium text-gray-900">Edit Store Contact</h3>
                                   <p className="mt-1 text-sm text-gray-600">
                                        Edit a new contact. This contact will serve to be display anywhere it is needed.
                                   </p>
                              ...
                              <div className="px-4 py-5 sm:p-6">
                                   <div className="grid grid-cols-6 gap-6">
                                        <div className="col-span-12 text-right">
                                             <InertiaLink href={route('store.contact.index', data.id)} className="bg-transparent border border-gray-500 text-sm text-gray-500 p-2 rounded focus:outline-none hover:bg-gray-600 hover:text-gray-100 inline-flex items-center">
...
Edit.layout = page => <Layout children={page} header={'Edit Store Contact'} />;
