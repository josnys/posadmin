...
import { can, dateTimeFormat, dateFormat } from '../../../../utils';
          ...
          <React.Fragment key="uprofile">
               ...
               <DataContainer>
                    <div className="col-span-12 text-right">
                         <InertiaLink href={route('stock.index', data.store.id)} className="bg-transparent border border-gray-500 text-sm text-gray-500 p-1 rounded focus:outline-none hover:bg-gray-600 hover:text-gray-100 inline-flex items-center">
...
Show.layout = page => <Layout children={page} header={'View Stock'} />;
