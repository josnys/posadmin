...
const Create = () => {
     ...
     function handleSubmit(e) {
          ...
          Inertia.post(route('store.store'), formData).then(() => {
               setSending(false);
          });
     }
                         ...
                         <div className="md:col-span-1">
                              <div className="px-4 sm:px-0">
                                   ...
                                   <p className="mt-1 text-sm text-gray-600">
                                        Create a new store in the system. This will represent your store where you can manage everything about inventory, user's access, suppliers, products and so on.
                                   </p>
                              </div>
                         </div>
                         <DataCard>
                              <div className="px-4 py-5 sm:p-6">
                                   <div className="grid grid-cols-6 gap-6">
                                        <div className="col-span-12 text-right">
                                             <InertiaLink href={route('store.index')} className="bg-transparent border border-gray-500 text-sm text-gray-500 p-2 rounded focus:outline-none hover:bg-gray-600 hover:text-gray-100 inline-flex items-center">
...
Create.layout = page => <Layout children={page} header={'Create Store'} />;
