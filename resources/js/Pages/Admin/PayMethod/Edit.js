...
const Edit = () => {
     ...
     function handleSubmit(e) {
          e.preventDefault();
          setSending(true);
          Inertia.post(route('paymethod.update', data.id), values).then(() => {
               setSending(false);
          });
     }
                    ...
                    <ProfileCard>
                         <div className="md:col-span-1">
                              <div className="px-4 sm:px-0">
                                   <h3 className="text-lg font-medium text-gray-900">Edit Payment Method</h3>
                                   <p className="mt-1 text-sm text-gray-600">
                                        Edit payment methods to be accepted in the system.
                                   </p>
                              </div>
                         </div>
                         <DataCard>
...
Edit.layout = page => <Layout children={page} header={'Edit Payment Method'} />;
