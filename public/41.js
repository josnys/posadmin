...
var Create = function Create() {
  ...
  var iconClassesBtn = classnames__WEBPACK_IMPORTED_MODULE_10___default()('w-4 h-4 mr-2', {
  ...
  function handleSubmit(e) {
    e.preventDefault();
    setSearching(true); // Inertia.post(route('purchase-order.store', data.store.id), values).then((response) => {
